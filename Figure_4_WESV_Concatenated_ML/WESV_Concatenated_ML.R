setwd("/Users/julia/Dropbox/MAVIAN_Lab/Manuscripts/Myanmar/Data_Scripts_Figures/Figure_4_WESV_Concatenated_ML/")
library("ggtree")
library("phytools")
library("ggplot2")
library("ape")
...
# Load the tree
ml_tree <- read.tree("WESV_Concatenated_ML.treefile")
...
# Save the plot
ggsave("WESV_Concatenated_ML.pdf", width = 55, height = 15, units = "in", dpi = 600, limitsize = FALSE)